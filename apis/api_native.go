...
func (a *NativeApiService) GetBlock(ctx context.Context, blockNumberOrHash string, localVarOptionals *NativeApiGetBlockOpts) (models.Block, *http.Response, error) {
	var (
...
func (a *NativeApiService) GetContractEvents(ctx context.Context, topic string, address string, localVarOptionals *NativeApiGetContractEventsOpts) ([]models.LogEvent, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue []models.LogEvent
	)
...
func (a *NativeApiService) GetDateToBlock(ctx context.Context, date string, localVarOptionals *NativeApiGetDateToBlockOpts) (models.BlockDate, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue models.BlockDate
	)
...
func (a *NativeApiService) GetLogsByAddress(ctx context.Context, address string, localVarOptionals *NativeApiGetLogsByAddressOpts) (models.LogEventByAddress, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue models.LogEventByAddress
	)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v models.LogEventByAddress
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse, newErr
...
func (a *NativeApiService) GetNFTTransfersByBlock(ctx context.Context, blockNumberOrHash string, localVarOptionals *NativeApiGetNFTTransfersByBlockOpts) (models.NftTransferCollection, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
func (a *NativeApiService) GetTransaction(ctx context.Context, transactionHash string, localVarOptionals *NativeApiGetTransactionOpts) (models.BlockTransaction, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue models.BlockTransaction
	)
...
func (a *NativeApiService) RunContractFunction(ctx context.Context, body models.RunContractDto, functionName string, address string, localVarOptionals *NativeApiRunContractFunctionOpts) (string, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
