...
func (a *TokenApiService) GetAllTokenIds(ctx context.Context, address string, localVarOptionals *TokenApiGetAllTokenIdsOpts) (models.NftCollection, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue models.NftCollection
	)
...
func (a *TokenApiService) GetContractNFTTransfers(ctx context.Context, address string, localVarOptionals *TokenApiGetContractNFTTransfersOpts) (models.NftTransferCollection, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue models.NftTransferCollection
	)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v models.NftTransferCollection
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse, newErr
...
func (a *TokenApiService) GetNFTLowestPrice(ctx context.Context, address string, localVarOptionals *TokenApiGetNFTLowestPriceOpts) (models.Trade, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue models.Trade
	)
...
func (a *TokenApiService) GetNFTMetadata(ctx context.Context, address string, localVarOptionals *TokenApiGetNFTMetadataOpts) (models.NftContractMetadata, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue models.NftContractMetadata
	)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v models.NftContractMetadata
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse, newErr
...
func (a *TokenApiService) GetNFTOwners(ctx context.Context, address string, localVarOptionals *TokenApiGetNFTOwnersOpts) (models.NftOwnerCollection, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue models.NftOwnerCollection
	)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v models.NftOwnerCollection
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse, newErr
...
func (a *TokenApiService) GetNFTTrades(ctx context.Context, address string, localVarOptionals *TokenApiGetNFTTradesOpts) (models.TradeCollection, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue models.TradeCollection
	)
...
func (a *TokenApiService) GetNftTransfersFromToBlock(ctx context.Context, localVarOptionals *TokenApiGetNftTransfersFromToBlockOpts) (models.NftTransferCollection, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
func (a *TokenApiService) GetTokenAddressTransfers(ctx context.Context, address string, localVarOptionals *TokenApiGetTokenAddressTransfersOpts) (models.Erc20TransactionCollection, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue models.Erc20TransactionCollection
	)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v models.Erc20TransactionCollection
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse, newErr
...
func (a *TokenApiService) GetTokenAllowance(ctx context.Context, address string, ownerAddress string, spenderAddress string, localVarOptionals *TokenApiGetTokenAllowanceOpts) (models.Erc20Allowance, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue models.Erc20Allowance
	)
...
func (a *TokenApiService) GetTokenIdMetadata(ctx context.Context, address string, tokenId string, localVarOptionals *TokenApiGetTokenIdMetadataOpts) (models.Nft, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue models.Nft
	)
...
func (a *TokenApiService) GetTokenIdOwners(ctx context.Context, address string, tokenId string, localVarOptionals *TokenApiGetTokenIdOwnersOpts) (models.NftOwnerCollection, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
func (a *TokenApiService) GetTokenMetadata(ctx context.Context, addresses []string, localVarOptionals *TokenApiGetTokenMetadataOpts) ([]models.Erc20Metadata, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue []models.Erc20Metadata
	)
...
func (a *TokenApiService) GetTokenMetadataBySymbol(ctx context.Context, symbols []string, localVarOptionals *TokenApiGetTokenMetadataBySymbolOpts) ([]models.Erc20Metadata, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
func (a *TokenApiService) GetTokenPrice(ctx context.Context, address string, localVarOptionals *TokenApiGetTokenPriceOpts) (models.Erc20Price, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue models.Erc20Price
	)
...
func (a *TokenApiService) GetWalletTokenIdTransfers(ctx context.Context, address string, tokenId string, localVarOptionals *TokenApiGetWalletTokenIdTransfersOpts) (models.NftTransferCollection, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
func (a *TokenApiService) ReSyncMetadata(ctx context.Context, address string, tokenId string, localVarOptionals *TokenApiReSyncMetadataOpts) (models.MetadataResync, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue models.MetadataResync
	)
 ...
 * @param optional nil or *TokenApiSearchNFTsOpts - Optional Parameters:
     ...
     * @param "Addresses" (optional.Interface of []string) -  The addresses to get metadata for
     * @param "Cursor" (optional.String) -  cursor
     * @param "Limit" (optional.Int32) -  limit
...
func (a *TokenApiService) SearchNFTs(ctx context.Context, q string, localVarOptionals *TokenApiSearchNFTsOpts) (models.NftMetadataCollection, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue models.NftMetadataCollection
	)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v models.NftMetadataCollection
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse, newErr
