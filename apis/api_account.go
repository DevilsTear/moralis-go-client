...
func (a *AccountApiService) GetNFTTransfers(ctx context.Context, address string, localVarOptionals *AccountApiGetNFTTransfersOpts) (models.NftTransferCollection, *http.Response, error) {
	var (
...
func (a *AccountApiService) GetNFTs(ctx context.Context, address string, localVarOptionals *AccountApiGetNFTsOpts) (models.NftOwnerCollection, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
func (a *AccountApiService) GetNFTsForContract(ctx context.Context, address string, tokenAddress string, localVarOptionals *AccountApiGetNFTsForContractOpts) (models.NftOwnerCollection, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
func (a *AccountApiService) GetNativeBalance(ctx context.Context, address string, localVarOptionals *AccountApiGetNativeBalanceOpts) (models.NativeBalance, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue models.NativeBalance
	)
...
func (a *AccountApiService) GetTokenBalances(ctx context.Context, address string, localVarOptionals *AccountApiGetTokenBalancesOpts) ([]models.Erc20TokenBalance, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue []models.Erc20TokenBalance
	)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v []models.Erc20TokenBalance
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse, newErr
...
func (a *AccountApiService) GetTokenTransfers(ctx context.Context, address string, localVarOptionals *AccountApiGetTokenTransfersOpts) (models.Erc20TransactionCollection, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
...
func (a *AccountApiService) GetTransactions(ctx context.Context, address string, localVarOptionals *AccountApiGetTransactionsOpts) (models.TransactionCollection, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
		localVarFileBytes   []byte
		localVarReturnValue models.TransactionCollection
	)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v models.TransactionCollection
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse, newErr
